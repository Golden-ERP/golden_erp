...
public class TypeCout extends Entity implements Serializable {
    ...
    public TypeCout(String aReference, String aType) {
        this();
    ...
    private void setType(String aType) {
        this.assertArgumentNotEmpty(aType, "Le type de cout est réquis.");
        this.type = aType;
    }
